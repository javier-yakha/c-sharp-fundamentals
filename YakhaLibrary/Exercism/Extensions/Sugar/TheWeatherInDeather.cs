...
namespace YakhaLibrary.Exercism.Extensions.Sugar
{
    public class WeatherStation
    {
        ...
        {
            // Worsens readability
            get => reading.Equals(new Reading()) ? throw new ArgumentException() : reading.Pressure < 10m && reading.Temperature < 30m ? Outlook.Cool : reading.Temperature > 50 ? Outlook.Good : Outlook.Warm;
        }
